...
best_model_path = '../tr_models/classifierX31d_1_best.pth'
last_model_path = '../tr_models/classifierX31d_1_last.pth'
plot_vals_path = '../outputs/classifierX31d_1_plotres.pkl'
